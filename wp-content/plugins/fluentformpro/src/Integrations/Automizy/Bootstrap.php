...
class Bootstrap extends IntegrationManager
{
        ...
        return [
            'fields'              => [
                ...
                [
                    ...
                    'tips'               => 'Associate your Automizy merge tags to the appropriate Fluent Forms fields by selecting the appropriate form field from the list.',
                ...
                [
                    ...
                    'tips'         => 'Select which Fluent Forms fields pair with their<br /> respective Automizy fields.',
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if (!$listId) {
            do_action('fluentform/integration_action_result', $feed, 'failed', 'Automizy API call has been skipped because no valid List available');
        }
        ...
        if (!empty($result['error'])) {
            ...
            do_action('fluentform/integration_action_result', $feed, 'success', 'Automizy feed has been successfully initialed and pushed data');
        }
    }
