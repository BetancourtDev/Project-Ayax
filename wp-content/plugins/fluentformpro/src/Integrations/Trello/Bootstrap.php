    ...
    */
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        $data = [
            ...
            'desc'   => str_replace("<br />", '', ArrayHelper::get($feedData, 'card_description')),
        ...
        if (!is_wp_error($response) && isset($response['id'])) {
            do_action('fluentform/integration_action_result', $feed, 'success', 'Trello feed has been successfully initialed and pushed data');
        } else {
